...
INSERT INTO `movies` (`movie_id`, `title`, `ranking`, `rating`, `year`, `votes`, `duration`, `oscars`, `budget`) VALUES (8, 'Schindlerâ€™s List', 8, 8.9, 1993, 494277, 195, 7, 25000000);
...
INSERT INTO `movies` (`movie_id`, `title`, `ranking`, `rating`, `year`, `votes`, `duration`, `oscars`, `budget`) VALUES (11, 'Star Wars: Episode 5 â€“ The Empire Strikes', 11, 8.8, 1980, 472269, 124, 1, 18000000);
...
INSERT INTO `movies` (`movie_id`, `title`, `ranking`, `rating`, `year`, `votes`, `duration`, `oscars`, `budget`) VALUES (13, 'One Flew Over the Cuckooâ€™s Nest', 13, 8.8, 1975, 402804, 133, 5, 4400000);
